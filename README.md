...
```shell
  docker buildx build -t ancieque/docker-sind-extension:latest . --load
```

To install the extension, use `make install-extension` **or**:

```shell
  docker extension install ancieque/docker-sind-extension:latest
```
...
```shell
  docker extension dev ui-source ancieque/docker-sind-extension:latest http://localhost:3000
```

In order to open the Chrome Dev Tools for your extension when you click on the extension tab, run:

```shell
  docker extension dev debug ancieque/docker-sind-extension:latest
```

Each subsequent click on the extension tab will also open Chrome Dev Tools. To stop this behaviour, run:

```shell
  docker extension dev reset ancieque/docker-sind-extension:latest
```
...
```shell
docker extension update ancieque/docker-sind-extension:latest
```
...
```shell
docker extension rm ancieque/docker-sind-extension:latest
```
